...
class Card:
    ...
    def __cmp__(self, other):
        ...
        # si los colores son iguales, el de menor número se considera primero
...
class Player(LinkedPriorityQueue):
    ...
    def __init__(self, name):
        ...
        self.__name = name
        # aunque no se muestre, tiene una lista de items, las cartas, heredada, que comienza vacía
    ...
    # comprobar si puede jugar, si una de sus cartas es compatible con la pasada como parámetro
    def can_play_card(self, card):
        for card_i in self.get_items():
            if card.check_card(card_i): # comprueba cada carta de la iteración
                return True
        return False
    
    # quita de las cartas del jugador la carta del índice escogido, para enviarla a la pila
    ...
    # función para probar la funcionalidad de los objetos de esta clase
    def test(self):  
        print "{PLAYER TEST}"
...
class Deck(LinkedQueue):
    ...
    def __init__(self, player_num):
        ...
        # iteración para obtener todas las combinaciones de cartas deseadas
    ...
    # calcula las cartas a generar según el numero de jugadores
    ...
    # añade al jugador especificado una carta aleatoria del mazo
...
class Discard_Pile (LinkedStack):
    ...
    # retorna como muestra la última carta de la pila
...
class ONE():
    ...
    def __init__(self):
        ...
        self.__deck = list() # ahora es algo vacío, se inicializa con el numero de jugadores preguntado luego
    ...
    def run_game(self):
        ...
        while (not self.stop_criterion(self.get_current_player())):
            # si va a robar cartas, muestra antes las iniciales, por criterio estético
            ...
            while self.current_can_play():
                ...
                # una vez se ha escogido una carta válida, se juega con ella
                ...
                # si alguien se queda sin cartas al lanzar una carta especial, se acaba aquí el juego
    ...
    def define_players(self):   
        ...
        # añade el numero de jugadores necesarios con sus nombres preguntados
    ...
    def ask_player_num(self):
        while (True):
            # preguntamos cuántos jugadores juegan, insistiendo hasta que el input tiene validez
            try:
